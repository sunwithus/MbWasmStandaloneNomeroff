...
public class NomeroffService
{
    ...
    /// <summary>Отправить кадр на распознавание (только Python API).</summary>
    ...
    /// <summary>Захват кадра с видео и отправка на API.</summary>
    ...
    /// <summary>Воспроизвести звук оповещения.</summary>
