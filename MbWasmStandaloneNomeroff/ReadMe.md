...
Сделать вывод координат в браузере (какой-то usb-глонасс я подключил к ПК)
на Settings.razor сделай тест gps и возможность выбора устройства - аналогично как с камерой

Позже:
Гео-дедупликация - Не писать один номер 10 раз на одном перекрёстке
Настройка дедупа на UI - Гибкость под сценарий (парковка/трасса)
